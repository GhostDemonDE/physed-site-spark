...
//
// Set SITE_BASE_PATH when building for a different location:
//   SITE_BASE_PATH=/new/dist npm run build   (subfolder deploy, current default)
//   SITE_BASE_PATH=/ npm run build           (root deploy, e.g. dcfamily.net)
